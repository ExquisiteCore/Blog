...
export function generateImageUrl(
  image?: string,
  baseUrl = 'https://blog.exquisitecore.xyz'
): string {
      ...
      return {
        ...
        potentialAction: {
          ...
          target: {
            '@type': 'EntryPoint',
            urlTemplate:
              'https://blog.exquisitecore.xyz/search?q={search_term_string}',
          },
 ...
 * @returns 验证结果
 */
export function validateSEOData(data: any): {
  isValid: boolean;
  errors: string[];
} {
  const errors: string[] = [];
