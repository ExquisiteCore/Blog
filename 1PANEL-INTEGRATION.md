...
根据 [1Panel 官方文档](https://docs.1panel.pro/quick_start/)，1Panel 是一个现代化的 Linux 服务器运维管理面板，主要通过 **容器编排** 和 **网站管理** 两个核心功能来管理应用。
...
**重要说明**：
- 使用 `location /api/` 和 `proxy_pass http://127.0.0.1:8080/api/` 确保路径正确转发
